...
This was built in 3-4 weeks as a final project for a web development course during my Erasmus exchange in Italy. The code reflects rapid development under tight deadlines. While it works and demonstrates core concepts (authentication, real-time features, SQL security), it's not representative of my current coding standards.
